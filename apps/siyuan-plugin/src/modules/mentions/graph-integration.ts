...
import { isBlock, type CurrentGraph } from "../../core/scope/graph-model";
import type { GraphDataset, GraphEdge } from "../../core/graph/types";
...
export function withMentionEdges(base: CurrentGraph, mentions: readonly GraphEdge[]): CurrentGraph {
  ...
  return { ...base, edges: [...base.edges, ...valid] };
}
